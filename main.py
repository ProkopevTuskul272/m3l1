...
factc_list = ['Большинство людей, страдающих технологической зависимостью, испытывают сильный стресс, когда они находятся вне зоны покрытия сети или не могут использовать свои устройства',
...
def random_fact():
    return f'{choice(factc_list)}'

@app.route("/haha")
def elgato():
    return '<img src="D:\Python\m3l1\static\img\elgato.png" alt="Image 1">'
